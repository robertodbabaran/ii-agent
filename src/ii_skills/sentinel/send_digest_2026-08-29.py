#!/usr/bin/env python3
"""
SENTINEL — Weekly AI Agent Ecosystem Digest 2026-08-29
...
SUBJECT = "CLAUDE: Sentinel Weekly Digest — 2026-08-29 [IMPLEMENTED]"
DIGEST_HTML_PATH = Path(__file__).parent / "digest_2026-08-29.html"
